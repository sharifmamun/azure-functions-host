...
namespace Microsoft.Azure.WebJobs.Script
{
    public class ScriptHost : JobHost, IScriptJobHost
    {
        ...
        internal async Task InitializeFunctionDescriptorsAsync(IEnumerable<FunctionMetadata> functionMetadata)
        {
            ...
            {
                _logger.LogInformation("Adding Function descriptor providers for all languages.");
            ...
            {
                _logger.LogInformation($"Adding Function descriptor provider for language {_currentRuntimelanguage}.");
            ...
            {
                _logger.LogInformation("Creating function descriptors.");
                functions = await GetFunctionDescriptorsAsync(functionMetadata, _descriptorProviders);
                _logger.LogInformation("Function descriptors created.");
            }
